            ...
            <div className="container mx-auto flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start md:gap-12">
                    <div className="mb-8 md:mb-0 md:w-1/3 flex justify-center">
                        <img  src="/image/myimg.jpg"  alt="Creator"  className="rounded-full shadow-lg w-48 h-48 object-cover"  />
                    </div>
                    <div className="md:w-2/3 text-center md:text-left">
                        ...
                        <p className="mb-4 text-lg leading-relaxed">
                            My speciality lies in Full Stack Developement . My goal is to create content that is both educational and engaging, making learning new technologies fun and accessible.
                        </p>
                        <p className="mb-4 text-lg leading-relaxed">
