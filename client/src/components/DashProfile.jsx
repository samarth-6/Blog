...
export default function DashProfile() {
  ...
  return (
    <div className='mx-w-lg mx-auto p-3 w-full'>
       ...
       <div className="text-red-500 justify-between mt-5 flex flex-row">
       ...
       size='md'>
           ...
           <Modal.Body>
            <div className="text-center">
              ...
              <h3 className='mb-5 text-lg text-black-500  dark:text-gray-400'>Do You Really Want to delete Your Account</h3>
